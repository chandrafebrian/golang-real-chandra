...
// // cara baca : membuat interface kontrak dengan nama Hasname dan didalam nya ada method func dengan nama Getname() yg wajib di sebutkan saat memanggil Hasname
