...
// func kembalikanNilai(name string) string {

// 	if name == "" {
// 		return "hello bro string kosong nih"
// 	} else {
// 		return "anjay mamen " + name
// 	}

// }

// // cara memanggil func return value dengan membuat variable key baru , lalu di return nama func tersebut
// func main() {
// 	hasil := kembalikanNilai("chandra")
// 	fmt.Println(hasil)
